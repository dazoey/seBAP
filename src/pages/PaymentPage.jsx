          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <form onSubmit={handlePaymentSubmit}>
                ...
                <div className="mb-6"><label className="block text-gray-700 mb-2">Catatan (Opsional)</label><textarea className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Tolong paket taruh genteng"></textarea></div>
