  ...
  <div className="min-h-screen py-8">
    <div className="container mx-auto px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8 text-gray-800">Tentang seBAP</h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">Cerita Kami</h2>
            <p className="text-gray-600 mb-4">pada suatu hari.........</p>
          </div>
        ...
        {/* <div className="bg-yellow-500 text-white rounded-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center"><Phone className="w-12 h-12 mx-auto mb-4 p-2 bg-black rounded-full" /><h3 className="font-semibold mb-2">Telepon</h3><p className="text-blue-100">089619525316</p><p className="text-sm text-blue-100 mt-1">Senin - Minggu: 12:00 - 22:00</p></div>
            <div className="text-center"><Mail className="w-12 h-12 mx-auto mb-4 p-2 bg-black rounded-full" /><h3 className="font-semibold mb-2">Email</h3><p className="text-blue-100">ayathaarch@gmail.com</p><p className="text-sm text-blue-100 mt-1">Respon dalam 25 jam</p></div>
            <div className="text-center"><MapPin className="w-12 h-12 mx-auto mb-4 p-2 bg-black rounded-full" /><h3 className="font-semibold mb-2">Alamat</h3><p className="text-blue-100">Jl.tiap weeknd</p><p className="text-sm text-blue-100 mt-1">Bogor, Indonesia</p></div>          </div>
          <div className="text-center mt-8"><button className="bg-white text-black px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Hubungi Sekarang</button></div>
        </div> */}
      </div>
    </div>
  </div>
